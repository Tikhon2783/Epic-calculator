...
---
### !!! К сожалению, не успел доделать до дедлайна, очень прошу дать время до среды, нужно доделать пару методов и переписать readme - оно уже не актуально 
Во вторник почти весь вечер провозился с одной проблемой во фронте, оказалось, что дело в браузере(
